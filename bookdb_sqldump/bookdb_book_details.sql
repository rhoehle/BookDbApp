...
CREATE TABLE `book_details` (
  ...
  KEY `book_details_rifk_idx` (`READER_ID`),
  CONSTRAINT `book_details_rifk` FOREIGN KEY (`READER_ID`) REFERENCES `reader` (`READER_ID`)
...
INSERT INTO `book_details` VALUES (2,NULL,'2001-01-02','90');
